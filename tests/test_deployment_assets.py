...
class DeploymentAssetTests(unittest.TestCase):
    ...
    def test_browser_interface_is_packaged_without_repository_hardcoding(self) -> None:
        ...
        self.assertIn('<details id="ask-investigation"', html)
        self.assertIn('<details id="answer-graph"', html)
        self.assertIn('id="answer-graph-canvas"', html)
        self.assertIn('id="answer-graph-zoom-in"', html)
        self.assertIn('id="answer-graph-zoom-out"', html)
        self.assertIn('id="answer-graph-fit"', html)
        self.assertIn("ask-investigation-toggle-label", html)
        self.assertIn('id="ask-response-depth"', html)
        self.assertIn('<option value="detailed">Detalhada</option>', html)
        self.assertIn("updateInvestigationToggleLabel", javascript)
        self.assertIn("function renderInvestigationGraph", javascript)
        self.assertIn("function bindGraphNavigation", javascript)
        self.assertIn("function explicitProjectConflict", javascript)
        self.assertIn("canvas.onwheel", javascript)
        self.assertIn("canvas.onpointermove", javascript)
        self.assertIn("response.investigation_graph", javascript)
        self.assertIn("document.createElementNS", javascript)
        self.assertIn('response_depth: responseDepth', javascript)
        self.assertIn('limit: responseDepth === "detailed" ? 14 : 10', javascript)
        self.assertIn("temperature: 0", javascript)
        self.assertIn('panel.dataset.hasSteps = String(hasSteps)', javascript)
        ...
        self.assertIn(".investigation-graph", css)
        self.assertIn(".graph-toolbar", css)
        self.assertIn(".graph-control", css)
        self.assertIn(".graph-node", css)
