            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "documents already present in the structural map. Use exact "
                        ...
                        "needed to explain it. These are coverage roles, not fixed "
                        "repository concepts; leave a role as a gap when the "
                        "observations do not expose it. "
                        "open_neighborhood and open_related may use only a chunk_id "
                        "present in observations. Return JSON "
