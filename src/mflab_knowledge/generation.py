            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "of filling it from memory. A path proves location, not the "
                        "meaning of generic configuration keys. Attribute a setting "
            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "queries, identifiers, and aspects. You may use general "
                        "scientific and "
                        ...
                        "plausible symbols or path terms. For initialization and "
                        "location questions, keep object construction or factory "
                        "selection distinct from later configuration, setup, "
            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "needed to explain it. A method that only receives or stores "
                        "an already-created object does not explain its construction. "
                        "When initialization is requested, keep construction or "
                        "factory selection, concrete implementation, later setup, "
                        "and runtime use as distinct coverage aspects whenever the "
                        "observations expose those stages. Give newly observed "
                        "caller/callee "
            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "An isolated cited symbol or path label claims only that the "
                        "item exists in that source; it does not claim invocation, "
                        "control flow, or runtime use. A definition establishes only "
                        "its local behavior. Claims that a stage starts, calls, "
                        "precedes, follows, or causes another stage require cited text "
                        "that directly shows that relationship; seeing both endpoints "
                        "in unrelated sources is insufficient. A configuration file "
                        "directly proves visible keys and values, but its path or a "
                        "nearby domain term does not prove which subsystem, object, or "
                        "runtime phase those settings control. "
            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "aspect is covered, partial, or gap. aspect is a stable planning "
                        "label; when question_span is present, use it as the exact user "
                        "wording that the label represents. A broad label does not demand "
                        "an exhaustive survey beyond that requested span. covered means "
                        "at least one "
                        ...
                        "Judge each aspect independently, not against every other part "
                        "of the question. covered does not require every possible "
                        "implementation detail or every available source; it means the "
                        "claims collectively provide the fact, form, or flow requested "
                        "by that aspect. Do not return partial merely because another "
                        "aspect remains incomplete. Use partial only when you can "
                        "identify a missing part within the current aspect itself. "
            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "the claim addresses the user's requested operation. "
                        "A file path alone does not establish the meaning or ownership "
                        "of generic configuration values. Otherwise use unsupported "
                        "or uncertain with no invented source. Return "
